...
class UpdateNumberSentReceived(BaseJob):
    def __init__(self,
                 addresses: list[str],
                 # chain_name: str,
                 chain_id: str,
...
#     _chain_name = input("Name of the chain to get numberSent/numberReceived (bsc or ethereum): ")
...
#                 count=True)
#
#             n_addresses = list(arango.query(f"RETURN LENGTH({_chain_name}_addresses)"))[0]
...
#                 job = UpdateNumberSentReceived(address_keys=_addr_keys,
